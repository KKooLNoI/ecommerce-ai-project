...
st.set_page_config(page_title="Data Overview", page_icon="📊", layout="wide", initial_sidebar_state="expanded")
...
_full   = os.path.join(ROOT, 'dataset', 'ML', 'amazon_products.csv')
_sample = os.path.join(ROOT, 'dataset', 'ML', 'amazon_products_sample.csv')
