...
cats = pd.read_csv('data/amazon_categories.csv', encoding='utf-8')
...
joblib.dump(sales_category_map, 'models/sales_category_map.pkl')
...
# 9. บันทึกโมเดล
# ═══════════════════════════════════════════════════════
joblib.dump(clf, 'models/sales_model.pkl')
...
joblib.dump(meta, 'models/sales_model_meta.pkl')
