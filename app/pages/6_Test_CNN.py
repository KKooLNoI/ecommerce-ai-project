...
<div style="font-family:'Prompt',sans-serif;font-size:.72rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:#64748B;margin-bottom:.8rem">วิธีใช้งาน CNN</div>
<div style="font-family:'Sarabun',sans-serif;font-size:.82rem;color:#94A3B8;line-height:1.8">
1️⃣ อัปโหลดรูปสินค้า<br>
2️⃣ กดปุ่มจำแนกรูปภาพ<br>
3️⃣ ดู Top-5 ผลลัพธ์<br>
4️⃣ ตรวจสอบ confidence
</div></div>
<div style="background:#1E2235;border:1px solid #2D3250;border-radius:12px;padding:1rem 1.1rem">
<div style="font-family:'Prompt',sans-serif;font-size:.72rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:#64748B;margin-bottom:.7rem">ความมั่นใจ (Confidence)</div>
<div style="display:flex;justify-content:space-between;padding:.3rem 0;border-bottom:1px solid #2D3250">
  <span style="font-family:'Sarabun',sans-serif;font-size:.8rem;color:#34D399">🟢 สูง</span>
  <span style="font-family:'Prompt',sans-serif;font-size:.8rem;font-weight:700;color:#E2E8F0">≥70%</span>
</div>
<div style="display:flex;justify-content:space-between;padding:.3rem 0;border-bottom:1px solid #2D3250">
  <span style="font-family:'Sarabun',sans-serif;font-size:.8rem;color:#FBBF24">🟡 กลาง</span>
  <span style="font-family:'Prompt',sans-serif;font-size:.8rem;font-weight:700;color:#E2E8F0">40–69%</span>
</div>
<div style="display:flex;justify-content:space-between;padding:.3rem 0">
  <span style="font-family:'Sarabun',sans-serif;font-size:.8rem;color:#F87171">🔴 ต่ำ</span>
  <span style="font-family:'Prompt',sans-serif;font-size:.8rem;font-weight:700;color:#E2E8F0">&lt;40%</span>
</div></div>
    """, unsafe_allow_html=True)
