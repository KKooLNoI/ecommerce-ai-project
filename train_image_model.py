...
def find_dataset():
    ...
    candidates = [
        DATA_DIR,                          # data/images/
        'data/amazon-products-image',      # ชื่อที่ Kaggle unzip ให้
        'data/Amazon Products Image',
        'data/images/train',               # บาง dataset มี train/ subfolder
    ]
...
CKPT = 'models/product_image_model_best.keras'
...
model.save('models/product_image_model.keras')

# บันทึก class indices → JSON
class_indices = {name: i for i, name in enumerate(class_names)}
with open('models/product_image_model_classes.json', 'w', encoding='utf-8') as f:
